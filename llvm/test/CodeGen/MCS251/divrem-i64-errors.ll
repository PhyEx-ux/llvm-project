; RUN: split-file %s %t
; RUN: not llc -mtriple=mcs251 -O0 %t/i64-div-dynhi.ll -o /dev/null 2>&1 | FileCheck %s --check-prefix=I64
; RUN: not llc -mtriple=mcs251 -O2 %t/i64-div-dynhi.ll -o /dev/null 2>&1 | FileCheck %s --check-prefix=I64
