...
@e16 = external global i16
@e32 = external global i32
@x16 = external global i16
@x32 = external global i32

; CHECK-LABEL: _read_e16:
define i16 @read_e16() {
  %v = load volatile i16, ptr @e16, align 1
  ret i16 %v
}

; CHECK-LABEL: _read_e32:
define i32 @read_e32() {
  %v = load volatile i32, ptr @e32, align 1
  ret i32 %v
}

; CHECK-LABEL: _read_x16:
define i16 @read_x16() {
  %v = load volatile i16, ptr @x16, align 1
  ret i16 %v
}

; CHECK-LABEL: _read_x32:
define i32 @read_x32() {
  %v = load volatile i32, ptr @x32, align 1
  ret i32 %v
}

; CHECK-LABEL: _write_e16:
define void @write_e16(i16 %v) {
  store volatile i16 %v, ptr @e16, align 1
  ret void
}

; CHECK-LABEL: _write_e32:
define void @write_e32(i32 %v) {
  store volatile i32 %v, ptr @e32, align 1
  ret void
}

; CHECK-LABEL: _write_x16:
define void @write_x16(i16 %v) {
  store volatile i16 %v, ptr @x16, align 1
  ret void
}

; CHECK-LABEL: _write_x32:
define void @write_x32(i32 %v) {
  store volatile i32 %v, ptr @x32, align 1
  ret void
}
...
define void @trunc_store16(i32 %v) {
  %r = trunc i32 %v to i16
  store volatile i16 %r, ptr @x16, align 1
  ret void
}

; CHECK-LABEL: _zext_load16:
define i32 @zext_load16() {
  %v = load volatile i16, ptr @x16, align 1
  %r = zext i16 %v to i32
  ret i32 %r
}
