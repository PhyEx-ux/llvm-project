...
@llvm.used = appending global [4 x ptr] [ptr addrspacecast (ptr addrspace(4) @irq1 to ptr), ptr addrspacecast (ptr addrspace(4) @irq2 to ptr), ptr addrspacecast (ptr addrspace(4) @irq3 to ptr), ptr addrspacecast (ptr addrspace(4) @irq4 to ptr)], section "llvm.metadata"

; Function Attrs: noinline nounwind optnone
define dso_local mcs251_intrcc void @irq1() addrspace(4) #0 {
  call addrspace(4) void @s1(i16 noundef zeroext 3, i16 noundef zeroext 4) #5
  ret void
}

; Function Attrs: noinline nounwind optnone
define internal void @s1(i16 noundef zeroext %0, i16 noundef zeroext %1) addrspace(4) #1 {
...
define dso_local mcs251_intrcc void @irq2() addrspace(4) #2 {
  call addrspace(4) void @s2(i16 noundef zeroext 3, i16 noundef zeroext 4) #5
  ret void
}

; Function Attrs: noinline nounwind optnone
define internal void @s2(i16 noundef zeroext %0, i16 noundef zeroext %1) addrspace(4) #1 {
  %3 = alloca i16, align 1
  %4 = alloca i16, align 1
  store i16 %0, ptr %3, align 1
  store i16 %1, ptr %4, align 1
...
define dso_local mcs251_intrcc void @irq3() addrspace(4) #3 {
  call addrspace(4) void @s3(i16 noundef zeroext 3, i16 noundef zeroext 4) #5
  ret void
}

; Function Attrs: noinline nounwind optnone
define internal void @s3(i16 noundef zeroext %0, i16 noundef zeroext %1) addrspace(4) #1 {
  %3 = alloca i16, align 1
  %4 = alloca i16, align 1
  store i16 %0, ptr %3, align 1
  store i16 %1, ptr %4, align 1
...
; Function Attrs: noinline nounwind optnone
define dso_local mcs251_intrcc void @irq4() addrspace(4) #4 {
  call addrspace(4) void @s4(i16 noundef zeroext 3, i16 noundef zeroext 4) #5
  ret void
}

; Function Attrs: noinline nounwind optnone
define internal void @s4(i16 noundef zeroext %0, i16 noundef zeroext %1) addrspace(4) #1 {
  %3 = alloca i16, align 1
  %4 = alloca i16, align 1
  store i16 %0, ptr %3, align 1
  store i16 %1, ptr %4, align 1
...
attributes #4 = { noinline nounwind optnone "frame-pointer"="all" "mcs251-isr-vector"="4" "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
attributes #5 = { nobuiltin "no-builtins" }

!llvm.module.flags = !{!0, !1}
!llvm.ident = !{!2}
!mcs251.signatures = !{!3, !4, !5, !6, !7}
